...
function M.open()
    ...
    local lines = {
        ...
        "dd          вирізати картку",
        "yy          копіювати картку",
        "dp          перенести картку в файл ./fork.org", 
        "p           вставити картку",
        "u |<ctrl>+r відмінити | повторити зміни",  
        "U           історія змін",
        ...
        "S | E       сплющити рядки поля | в усіх картках",
        "R | X       формат поля з РНОКПП | для усіх карток",
        "0           схлопнути пусті поля карток",
        "i           редагувати поле редакторі",
        "a | f       шукати і вставити дані з бази Awards | з каталогу ~/STATYSTYKA",
