...
-- Динамічне отримання директорії та файлу з актуального config.lua
local function get_config_dir()
    return config.options.abbreviations_dir or (vim.fn.stdpath("config") .. "/awards53")
end

local function get_config_file()
    return get_config_dir() .. "/abbreviations.json"
end
