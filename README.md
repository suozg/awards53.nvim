...
Також вміє створювати повноцінні документи з шаблоеів libreoffice шляхом додавання тексту в визначені поля.
...
Наприклад - присилають підрозділи чернетки подань. Зазвичай табличка
